    ...
    <div>
        ...
        <div className="text-center">
          <div className="text-center">
            <p className="px-5 md:px-10 pt-10 pb-28 md:indent-5 text-justify md:text-center">
              ...
              encourages and works towards continuing education for the college
              employees. National Institute of Technology, Patna, also known as
              NIT Patna, is an Institute of National Importance. NIT Patna
              marked its humble beginning in 1886 and it is the 6th Oldest
      ...
      <div className="bg-[#510505] text-white pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 max-w-5xl mx-auto gap-10 group place-items-center">
          <div className="bg-white/10  hover:!blur-none mx-5 md:mx-0 cursor-pointer p-8 rounded-sm  flex flex-col place-items-center  group-hover:scale-[0.85] hover:!scale-100 ease-out duration-200">
          ...
          <div className="grid place-items-center bg-white/10 cursor-pointer mx-5 md:mx-0 p-8 rounded-sm  hover:!blur-none group-hover:scale-[0.85] hover:!scale-100 ease-out duration-200">
            <div className="flex justify-center">
          ...
          <div className="grid place-items-center bg-white/10  cursor-pointer p-8 mx-5 md:mx-0 rounded-sm  hover:!blur-none group-hover:scale-[0.85] hover:!scale-100 ease-out duration-200">
            <div className="flex justify-center">
